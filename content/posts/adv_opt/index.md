...
$$
\begin{align}
\min_x & \quad f(x+\delta)_{y=t} - \max_{y \ne t} f(x) - \tau \\\
\textit{s.t} & \quad ||\delta||_p \le \epsilon
\end{align} \tag{9}
$$
</span>
...
This was directly adapted from <a href="https://www.youtube.com/watch?v=GxK04B9SVg4">Lecture 11, Convex Optimisation, S.Boyd</a>
<center>
<span id='fig4'>
<img src="image-2.png" />
...
<p>[4] Sachit, <a href="adv.py"> Code to the adove experiments </a></p>